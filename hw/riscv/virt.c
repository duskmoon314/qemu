                            ...
                            uint32_t irq_mmio_phandle)
{
    ...
    qemu_fdt_setprop_cell(mc->fdt, name, "clock-frequency", 3686400);
    qemu_fdt_setprop_cell(mc->fdt, name, "interrupt-parent", irq_mmio_phandle);
    qemu_fdt_setprop_cell(mc->fdt, name, "interrupts", UART2_IRQ);
    ...
    qemu_fdt_setprop_cell(mc->fdt, name, "clock-frequency", 3686400);
    qemu_fdt_setprop_cell(mc->fdt, name, "interrupt-parent", irq_mmio_phandle);
    qemu_fdt_setprop_cell(mc->fdt, name, "interrupts", UART3_IRQ);

    name = g_strdup_printf("/soc/uart@%lx", (long)memmap[VIRT_UART4].base);
    qemu_fdt_add_subnode(mc->fdt, name);
    qemu_fdt_setprop_string(mc->fdt, name, "compatible", "ns16550a");
    qemu_fdt_setprop_cells(mc->fdt, name, "reg",
        0x0, memmap[VIRT_UART4].base,
        0x0, memmap[VIRT_UART4].size);
    qemu_fdt_setprop_cell(mc->fdt, name, "clock-frequency", 3686400);
    qemu_fdt_setprop_cell(mc->fdt, name, "interrupt-parent", irq_mmio_phandle);
    qemu_fdt_setprop_cell(mc->fdt, name, "interrupts", UART4_IRQ);
...
static void virt_machine_init(MachineState *machine)
{
    ...
    serial_mm_init(system_memory, memmap[VIRT_UART4].base,
        0, qdev_get_gpio_in(DEVICE(mmio_plic), UART4_IRQ), 399193,
